...
* 상품 번호: 제품의 고유 식별자입니다.
- 상품 정보: 제품에 대한 간략한 설명입니다.
- 가격: 제품의 가격입니다.
- 금액: 판매 가능한 제품의 단위 수입니다.
- 배송비: 고객에게 제품을 배송하는 비용입니다.
* 판매자가 이 정보를 입력하면 데이터베이스의 테이블에 새 행을 삽입합니다.
*제품 삭제: 판매자는 제품 번호를 입력하여 기존 제품을 삭제할 수 있습니다. 그런 다음 함수는 테이블에서 행을 삭제합니다.products
*제품 목록: 판매자는 함수를 호출하여 현재 등록된 모든 제품 목록을 볼 수 있습니다. 이 함수는 각 객체가 단일 제품을 나타내는 객체의 a를 반환합니다.getProducts()ListProductProduct
*제품 검색: 판매자는 제품 번호를 입력하여 특정 제품을 검색할 수 있습니다. 그런 다음 함수는 제품이 발견되거나 제품을 찾을 수 없는 경우 개체를 반환합니다.Productnull
```
